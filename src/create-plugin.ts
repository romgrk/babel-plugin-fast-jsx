  ...
  return declare((_, options: Options) => {
    ...
    if (process.env.BABEL_8_BREAKING) {
      if ("useSpread" in options) {
        throw new Error(
          '@babel/plugin-transform-fast-react-jsx: Since Babel 8, an inline object with spread elements is always used, and the "useSpread" option is no longer available. Please remove it from your config.',
        );
      }
      ...
      if ("useBuiltIns" in options) {
        ...
        throw new Error(
          `@babel/plugin-transform-fast-react-jsx: Since "useBuiltIns" is removed in Babel 8, you can remove it from the config.
    ...
    ["@babel/plugin-transform-object-rest-spread", { "loose": true, "useBuiltIns": ${useBuiltInsFormatted} }]
      ...
      if (RUNTIME_DEFAULT === "classic") {
        if (typeof useSpread !== "boolean") {
          throw new Error(
            "transform-fast-react-jsx currently only accepts a boolean option for " +
        ...
        if (useSpread && useBuiltIns) {
          throw new Error(
            "transform-fast-react-jsx currently only accepts useBuiltIns or useSpread " +
              "but not both",
          );
        }
      }
...
You can set \`throwIfNamespace: false\` to bypass this warning.`,
        ...
        Program: {
          ...
          //   ) {
          //     throw new Error(
          //       "transform-fast-react-jsx: pragma has been set but " +
