...
function createPlugin({ name, development, }) {
    return (0, helper_plugin_utils_1.declare)((_, options) => {
        ...
        const extendExpression = useBuiltIns ? toMemberExpression('Object.assign') : core_1.types.identifier('_extend');
        return {
            name,
            // inherits: jsx,
            visitor: {
        ...
        function processProps(node, type, props, maybeKey) {
            ...
            let key = maybeKey !== null && maybeKey !== void 0 ? maybeKey : core_1.types.buildUndefinedNode();
            let ref = core_1.types.buildUndefinedNode();
