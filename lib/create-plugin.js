...
function createPlugin({ name, development, }) {
    return (0, helper_plugin_utils_1.declare)((_, options) => {
        const { pure: PURE_ANNOTATION, throwIfNamespace = true, filter, runtime: RUNTIME_DEFAULT = "automatic", importSource: IMPORT_SOURCE_DEFAULT = DEFAULT.importSource, pragma: PRAGMA_DEFAULT = DEFAULT.pragma, pragmaFrag: PRAGMA_FRAG_DEFAULT = DEFAULT.pragmaFrag, } = options;
            ...
            visitor: {
                Program: {
                    ...
                    exit(path, pass) {
                        ...
                        if (state.needsPrelude) {
                            ...
                            const reactIdentifier = (_a = state.reactIdentifier) !== null && _a !== void 0 ? _a : '_react';
                            ...
                            if (needReactImport) {
                                const reactImport = core_1.types.importDeclaration([core_1.types.importSpecifier(core_1.types.identifier('_react'), core_1.types.identifier('react'))], core_1.types.stringLiteral('react'));
                ...
                CallExpression(path, pass) {
                    ...
                    if (core_1.types.isIdentifier(node.callee) && node.callee.name === state.jsxIdentifier) {
                        ...
                        const ref = (_a = findRef(props)) !== null && _a !== void 0 ? _a : core_1.types.buildUndefinedNode();
                        const key = (_b = findKey(props, maybeKey)) !== null && _b !== void 0 ? _b : core_1.types.buildUndefinedNode();
        ...
        function findRef(props) {
            return undefined;
        }
        function findKey(props, maybeKey) {
            return undefined !== null && undefined !== void 0 ? undefined : maybeKey;
        }
